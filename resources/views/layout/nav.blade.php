        ...
        <body>
            ...
            <div class="sidebar">
                <div class="sidebar-logo mb-100 mt-25">
                    <a href="{{ url('/') }}"><img
                            src="{{ asset('https://imgs.search.brave.com/HrlZ4j2HfBoFriokx-qOLfKh2pwclFZmC9TAjceElQ0/rs:fit:640:480:1/g:ce/aHR0cHM6Ly8yLmJw/LmJsb2dzcG90LmNv/bS8tb1RXYWx4a25f/ZE0vVWJXVjFnNEJf/cEkvQUFBQUFBQUFG/bTgvb3FmeUg3ZlB6/ejgvczE2MDAvZ2xv/c3N5K3JvdW5kK2Zs/YWcrb2Yram9yZGFu/LnBuZw') }}"
                            alt=""></a>
                </div>
                <div class="sidebar-icon">
                    <ul>
                        <li class="active"><a href="{{ url('/home') }}"><i class="fi-sr-home"></i> <span
                                    id="nav1">Home</span></a></li>
                        <li><a href="{{ url('/sites') }}"><i class="fi-sr-globe"></i><span id="nav2">
                                    Sites</span></a></li>
                        <li><a href="{{ url('centers') }}"><i class="fi-sr-building"></i><span id="nav3">Dive
                                    Center</span></a></li>
                        <li><a href="{{ url('') }}"><i class="fi-sr-camera"></i><span id="nav4">Fliter
                                    Image</span></a></li>
                        {{-- <li><a href="{{ url('category.html') }}"><i class="fi-sr-crown"></i></a></li> --}}
                        <li><a href="{{ url('') }}"><i class="fi-sr-book"></i><span
                                    id="nav5">Book</span></a></li>
                        <li><a href="{{ url('#') }}" id="btnFullscreen"><i class="fi-sr-user"></i><span
                                    id="nav6">Profile</span></a></li>
                    </ul>
                </div>
            </div>
            <!-- sidebar-end -->
                                        ...
                                        <nav class="menu-box">
                                            ...
                                            <div class="social-links">
                                                <ul class="clearfix">
                                                    ...
                                                    <li><a href="#"><span class="fab fa-facebook-f"></span></a>
                                                    </li>
